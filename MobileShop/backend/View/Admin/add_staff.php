                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="last_name" name="last_name"
                                                placeholder="Enter last name" minlength="3" pattern="[A-Za-z\s]+"
                                                oninput="checkLastname(this)" required>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="email" class="form-control" id="email" name="email"
                                                placeholder="example@mail.com" oninput="checkEmail(this)" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="tel" class="form-control" id="phone" name="phone"
                                                ...
                                                title="Phone number must be 10 digits only." oninput="checkPhone(this)"
                                                required>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" id="gender" name="gender"
                                                oninput="checkGender(this)" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" class="form-control" id="birth_date" name="birth_date"
                                                max="2020-01-01" min="1950-01-01" onchange="checkBirthDate(this)"
                                                required>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <label for="role" class="form-label">Role <span
                                                    class="text-danger">*</span></label>
                                            <select class="form-select" id="role" name="role" oninput="checkRole(this)"
                                                required>
                                                <option value="" selected>Choose...</option>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" id="status" name="status"
                                                oninput="checkStatus(this)" required>
                                                <option value="" selected>Choose...</option>
